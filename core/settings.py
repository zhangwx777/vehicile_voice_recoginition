...
PATH_CONFIG = {
    ...
    'model_save_path': os.path.join(PROJECT_ROOT, 'models', 'individual_best_model.pth'),
    'label_mapping_path': os.path.join(PROJECT_ROOT, 'models', 'individual_label_mapping.json'),
