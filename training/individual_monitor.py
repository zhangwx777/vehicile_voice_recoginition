...
def execute_individual_training():
    ...
    import json
    from utils.helpers import set_seed, ensure_dir, count_parameters
    ...
    try:
        ...
        # 修改路径配置为个体化数据集
        individual_data_dir = "vehicle_audio_data/individual_recognition/individual_vehicles"
        ...
        # 获取最佳验证准确率
        best_val_acc = max(training_results['val_accuracies']) if training_results['val_accuracies'] else 0.0
